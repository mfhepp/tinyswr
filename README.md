**Disclaimer:** The current release 1.2 dated October 24, 2017, and the PCB hosted at OSH Park after that date reflect a new, improved PCB design that is NOT YET TESTED. There might still be problems with the PCB. **Try at your own risk.** I will post here once I had the chance to test the new PCB.
